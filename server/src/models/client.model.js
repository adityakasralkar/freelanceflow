...
function createClient(freelancerId, data) {
  const { name, company, email, phone, location } = data;
  return query(
    `INSERT INTO clients (freelancer_id, name, company, email, phone, location)
     VALUES ($1, $2, $3, $4, $5, $6)
     RETURNING *`,
    [freelancerId, name, company || null, email || null, phone || null, location || null]
  );
}
